...
//        AtomicReference<Variant> atomicReference = new AtomicReference<Variant>(new Variant());
//        Variant varOld, varNew;
//        long timestamp, sequence;
//        while (true) {
//
//            // Save the old variant
//            varOld = atomicReference.get();
//
//            // populate the current variant
//            timestamp = TimeUtils.genTime(IdType.parse("min-granularity"));
//
//            varOld.lastTimestamp = timestamp;
...
//
//            if (atomicReference.compareAndSet(varOld, varNew)) {
